          ...
          return (
            ...
            >
              ...
              <div className="min-w-0">
                ...
                <p className="text-sm text-fg-secondary leading-body">{getOpportunityLabel(type)}</p>
              </div>
            </button>
          );
        })}
        ...
        {types.map((type) => {
          ...
          return (
            ...
            >
              ...
              {latest ? (
                <div className="mt-2 pt-2 border-t border-border-ds-primary">
                  <p className="text-xs text-fg-secondary truncate">{latest.title}</p>
                  {client && (
                    <p className="text-xs text-fg-secondary mt-0.5 truncate">{client.fullName}</p>
                  )}
                </div>
              ) : (
                <div className="mt-2 pt-2 border-t border-border-ds-primary">
                  <p className="text-xs text-fg-secondary">No opportunities yet</p>
                </div>
              )}
            </button>
          );
    ...
    <div className="space-y-4">
          ...
          return (
            ...
            >
              ...
              <span className={cn(
                ...
                isSelected ? "bg-white/20" : "bg-surface-ds-raised"
              )}>
                {count}
              </span>
            </button>
      ...
      {filteredOpportunities.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center py-12 text-center">
          <p className="text-sm text-fg-secondary">No {getOpportunityLabel(selectedType).toLowerCase()} opportunities</p>
        </div>
      )}
    </div>
  );
        ...
        {types.map((type, i) => {
          ...
          return (
            <div key={type} className="flex items-center gap-3">
              {i > 0 && <div className="w-px h-8 bg-border-ds-primary" />}
              <button
                onClick={() => setSelectedType(prev => (prev === type ? null : type))}
                className={cn(
                  "flex items-center gap-2.5 px-3 py-2 rounded-xl transition-all duration-300",
                  isSelected ? "bg-surface-ds-raised" : "hover:bg-surface-ds-raised/50",
                )}
              >
                <div
                ...
                <div className="text-left">
                  ...
                  <p className="text-xs text-fg-secondary leading-body">{getOpportunityLabel(type)}</p>
                </div>
              </button>
            </div>
          );
        ...
        return (
          <div key={type} className="space-y-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-fg-secondary">{count}</span>
              <button
                onClick={() => navigate('/opportunities')}
                className="ml-auto text-xs font-semibold text-fg-secondary hover:text-foreground transition-colors flex items-center gap-1"
              >
            ...
            {filtered.length > 0 ? (
              ...
              <div className="rounded-2xl border-2 border-dashed border-border-ds-primary p-6 flex items-center justify-center">
        ...
        {types.map((type) => {
          ...
          return (
            ...
            >
              ...
              <span className="text-xs text-fg-secondary hidden sm:inline">{getOpportunityLabel(type)}</span>
            </button>
          );
        })}
        <button
          onClick={() => navigate('/opportunities')}
          className="ml-auto flex items-center gap-1.5 text-sm font-semibold text-fg-secondary hover:text-foreground transition-colors"
        >
      ...
      <div className="bg-card rounded-2xl overflow-hidden">
        <div className="grid grid-cols-[3fr_2fr_0.6fr_0.3fr_0.4fr_minmax(72px,120px)] justify-items-start">
          ...
          <div className="contents">
            <span className="text-xs font-semibold text-fg-secondary py-3 border-b border-border-ds-primary self-stretch justify-self-stretch flex items-center pl-5">Opportunity</span>
            <span className="text-xs font-semibold text-fg-secondary py-3 border-b border-border-ds-primary self-stretch justify-self-stretch flex items-center pl-3">Client</span>
            <span className="text-xs font-semibold text-fg-secondary py-3 border-b border-border-ds-primary self-stretch justify-self-stretch flex items-center pl-3">Price</span>
            <span className="text-xs font-semibold text-fg-secondary py-3 border-b border-border-ds-primary self-stretch justify-self-stretch flex items-center pl-3">Beds</span>
            <span className="text-xs font-semibold text-fg-secondary py-3 border-b border-border-ds-primary self-stretch justify-self-stretch flex items-center pl-3">Matches</span>
            <span className="text-xs font-semibold text-fg-secondary py-3 border-b border-border-ds-primary self-stretch justify-self-stretch flex items-center justify-end gap-1 pr-5">Interaction <ArrowDown className="w-3 h-3" /></span>
          </div>
        </div>
          ...
          {filteredOpportunities.length > 0 ? filteredOpportunities.map((opp) => {
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-3 min-w-0 justify-self-stretch self-stretch py-3.5 pl-5 border-b border-border-ds-primary group-hover:bg-surface-ds-raised/50 transition-colors">
                ...
                {/* Client */}
                <div className="flex items-center gap-2.5 min-w-0 justify-self-stretch self-stretch py-3.5 pl-3 border-b border-border-ds-primary group-hover:bg-surface-ds-raised/50 transition-colors">
                  {client ? (
                    <>
                ...
                {/* Price */}
                <div className="flex items-center text-sm text-foreground tabular-nums leading-body text-left py-3.5 pl-3 border-b border-border-ds-primary group-hover:bg-surface-ds-raised/50 transition-colors justify-self-stretch self-stretch">
                ...
                {/* Matches */}
                <div className="flex items-center text-sm text-foreground tabular-nums leading-body text-left py-3.5 pl-3 border-b border-border-ds-primary group-hover:bg-surface-ds-raised/50 transition-colors justify-self-stretch self-stretch">3</div>

                {/* Last interaction */}
                <div className="flex items-center justify-end text-right min-w-0 justify-self-stretch self-stretch py-3.5 border-b border-border-ds-primary pr-5 group-hover:bg-surface-ds-raised/50 transition-colors">
                  <div>
                    <p className="text-xs text-foreground truncate leading-body">{getLastInteraction(opp.id).text}</p>
                    <p className="text-[11px] text-fg-secondary mt-0.5 leading-body">{getLastInteraction(opp.id).time}</p>
                  </div>
                </div>
        ...
        return (
          ...
          >
            ...
            <div className="min-w-0">
              ...
              <p className="text-sm text-fg-secondary leading-[140%]">{getOpportunityLabel(type)}</p>
            </div>
          </button>
        );
      })}
