...
>(({ className, children, hideCloseButton = false, overlayClassName, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-50 grid w-[calc(100%-2rem)] max-w-xl sm:max-w-xl md:max-w-2xl translate-x-[-50%] translate-y-[-50%] gap-4 border bg-card shadow-lg rounded-lg",
        "animate-fade-in-only data-[state=closed]:animate-fade-out-only",
        className,
      )}
      {...props}
    >
