// Dynamic generator for stress-testing UI density (used by agent-app's
// "many" data view mode). Produces N synthetic clients each with 0-3
// opportunities. Not part of the seeded canonical fixture set.

import type { Client, ClientWithOpportunities, Opportunity } from "../entities";
import type { OpportunityStatus, OpportunityType } from "../enums";
...
export const generateManyClients = (count: number): ClientWithOpportunities[] => {
  ...
  for (let i = 0; i < count; i++) {
    ...
    const oppStatuses: OpportunityStatus[] = ["new", "qualified", "active", "under-offer"];
