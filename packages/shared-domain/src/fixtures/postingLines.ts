...
export const sharedPostingLines: PostingLine[] = [
  ...
  // posting-003 — agent_invoice — deal-001, agent-001 (EUR 4 230.8 = 40% × net 10 577)
  ...
  // posting-010 — bonus — agent-001 (EUR 500, standalone REBU)
  ...
  // posting-011 — agent_invoice — deal-016, agent-004 (AED 16 115.4 = 42% × net 38 370)
  ...
  // posting-012 — incentive — agent-004 (AED 1 200, standalone REBU)
  ...
  // posting-013 — platform_fee — agent-004 (AED 300, standalone REBU)
  ...
  // posting-014 — platform_fee — agent-001 (EUR 150, standalone REBU)
  ...
  // posting-015 — agent_invoice — deal-018, agent-001 (EUR 9 220)
  ...
  // posting-016 — platform_fee — agent-001 Apr 2026 (EUR 150, standalone REBU)
  ...
  // posting-023 — conveyance_invoice — deal-001 Gestoría López (EUR 800 accrual)
  ...
  // posting-025 — conveyance_invoice — deal-008 Gestoría López (EUR 800 accrual, pending)
  ...
  // posting-026 — conveyance_invoice — deal-016 TAMM Legal (AED 3 000 accrual)
  ...
  // posting-028 — conveyance_invoice — deal-018 Gestoría López (EUR 1 200 accrual)
