...
export const sharedPostingLines: PostingLine[] = [
  ...
  // EUR 4 230.8 = 40% × net 10 577 (11 377 subtotal − 800 conveyance)
  { id: "pline-003-1", postingId: "posting-003", ledgerId: 7,  side: "DEBIT",  amount: 4230.8 },
  { id: "pline-003-2", postingId: "posting-003", ledgerId: 22, side: "CREDIT", amount: 4230.8 },
  ...
  // base 4 080.8 → clears commission accrual; input VAT 856.97; IRPF 612.12; net payable 4 325.65
  { id: "pline-004-1", postingId: "posting-004", ledgerId: 22, side: "DEBIT",  amount: 4080.8,  invoiceId: "inv-009" },
  { id: "pline-004-2", postingId: "posting-004", ledgerId: 5,  side: "DEBIT",  amount: 856.97,  invoiceId: "inv-009" },
  { id: "pline-004-3", postingId: "posting-004", ledgerId: 28, side: "CREDIT", amount: 612.12,  invoiceId: "inv-009" },
  { id: "pline-004-4", postingId: "posting-004", ledgerId: 22, side: "CREDIT", amount: 4325.65, invoiceId: "inv-009" },
  ...
  { id: "pline-030-1", postingId: "posting-030", ledgerId: 22, side: "DEBIT",  amount: 4325.65, invoiceId: "inv-009" },
  ...
  { id: "pline-023-2", postingId: "posting-023", ledgerId: 5,  side: "DEBIT",  amount: 168,    invoiceId: "inv-013" },
  ...
  { id: "pline-025-2", postingId: "posting-025", ledgerId: 5,  side: "DEBIT",  amount: 168,    invoiceId: "inv-014" },
  ...
  // posting-007 — invoice_issued — deal-016, inv-006 + inv-007
  // Triggered: outbound invoices draft → issued (Finance finalizes and sends PDFs to client and Emaar)
  // client 24 570 + dev 16 800 subtotals + VAT 5% 2 068.5 = gross 43 438.5
  { id: "pline-007-1", postingId: "posting-007", ledgerId: 9,  side: "DEBIT",  amount: 25798.5, invoiceId: "inv-006" },
  { id: "pline-007-2", postingId: "posting-007", ledgerId: 9,  side: "DEBIT",  amount: 17640,   invoiceId: "inv-007" },
  { id: "pline-007-3", postingId: "posting-007", ledgerId: 13, side: "CREDIT", amount: 41370 },
  { id: "pline-007-4", postingId: "posting-007", ledgerId: 12, side: "CREDIT", amount: 2068.5 },
  ...
  // Triggered: deal moves to finalized (system calculates and books agent liability — no invoice yet)
  // AED 16 115.4 = 42% × net 38 370 (41 370 subtotal − 3 000 conveyance)
  { id: "pline-011-1", postingId: "posting-011", ledgerId: 14, side: "DEBIT",  amount: 16115.4 },
  { id: "pline-011-2", postingId: "posting-011", ledgerId: 24, side: "CREDIT", amount: 16115.4 },
  ...
  { id: "pline-026-2", postingId: "posting-026", ledgerId: 12, side: "DEBIT",  amount: 150,    invoiceId: "inv-015" },
  ...
  // EUR 9 220 = 40% × net 23 050 (24 250 subtotal − 1 200 conveyance)
  ...
  { id: "pline-028-2", postingId: "posting-028", ledgerId: 5,  side: "DEBIT",  amount: 252,    invoiceId: "inv-016" },
  ...
  { id: "pline-031-2", postingId: "posting-031", ledgerId: 5,  side: "DEBIT",  amount: 105,   invoiceId: "inv-010" },
  { id: "pline-031-3", postingId: "posting-031", ledgerId: 28, side: "CREDIT", amount: 75,    invoiceId: "inv-010" },
  { id: "pline-031-4", postingId: "posting-031", ledgerId: 22, side: "CREDIT", amount: 530,   invoiceId: "inv-010" },
  ...
  { id: "pline-032-2", postingId: "posting-032", ledgerId: 12, side: "DEBIT",  amount: 850.77,   invoiceId: "inv-012" },
  { id: "pline-032-3", postingId: "posting-032", ledgerId: 24, side: "CREDIT", amount: 17866.17, invoiceId: "inv-012" },
