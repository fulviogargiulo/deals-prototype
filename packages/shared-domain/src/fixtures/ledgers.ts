...
export const sharedLedgers: Ledger[] = [
  ...
  { id: 3,  name: "LIAB_AGENT_EUR",              description: "Agent Liability GL (EUR)",          type: "liability", currency: "EUR" },
  ...
  { id: 10, name: "LIAB_AGENT_AED",              description: "Agent Liability GL (AED)",          type: "liability", currency: "AED" },
  ...
  { id: 17, name: "LIAB_AGENT_SAR",              description: "Agent Liability GL (SAR)",          type: "liability", currency: "SAR" },
