...
export const sharedAgents: Agent[] = [
  ...
  { id: "agent-008", uid: 1008, partyId: "party-ca-santiago-eur", country: "es", employmentStatus: "active" },
  { id: "agent-009", uid: 1009, partyId: "party-ca-isabel-eur",   country: "es", employmentStatus: "active" },
